...
public class ConvertUtils {
    ...
    private static final Map<String, Channel> rabbitChannelMap = MapUtil.newHashMap();
    private static final Map<String, Connection> rabbitConnectionMap = MapUtil.newHashMap();
     ...
     * @param message
     */
    public static void rabbitProducer(BasicBase base, String message) {
        ...
        try {
            ...
            if (Objects.isNull(connection)) {
                connection = connectionFactory.newConnection("mq-converter");
     ...
     * @param base
     */
    public static void rabbitConsumer(BasicBase base) {

        Consumer<String> consumer = message -> log.info("消息转换:{}",message);
        rabbitConsumer(base,consumer);
    }
     ...
     * @param base
     */
    public static void rabbitConsumer(BasicBase base, Consumer<String> convertTarget) {
        String host = base.getHost();
        int port = base.getPort();
        String username = base.getUsername();
        String password = base.getPassword();
        ...
        try {
            ...
            DefaultConsumer consumer = new DefaultConsumer(channel) {
                ...
                public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                    ...
                    log.info("接收到的信息 exchange:{},routingKey:{},message:{}", envelope.getExchange(), envelope.getRoutingKey(), message);
                    if (Objects.nonNull(convertTarget)) {
                        convertTarget.accept(message);
                    }
                }
            };
    ...
    public static void rocketConsumer(BasicBase base, Consumer<String> convertTarget) {
            ...
            MessageListenerConcurrently messageListener = (msgs, context) -> {
                for (MessageExt msg : msgs) {
                    try {
                        ...
                        log.info("RocketMQ消费者的消息体信息:{}", messageBody);
                        if (Objects.nonNull(convertTarget)) {
                            convertTarget.accept(messageBody);
                        }
                    } catch (Exception e) {
                        assert log != null;
                        log.error("Error parsing message body", e);
